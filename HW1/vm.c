...
void run(instructions IR, FILE *ofp);
void printStack(instructions IR, FILE *ofp);
...
void runvm(FILE *ifp, FILE *ofp){
	instructions IR[MAX_CODE_LENGTH];
	int i, count = 0;
